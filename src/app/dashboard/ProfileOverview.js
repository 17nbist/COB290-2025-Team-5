      ...
      */}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "30% 70%", height: "100%", width: "100%", backgroundColor: "blue" }}>
                ...
                <div style={{ padding: "10px" }}>
                    ...
                    <Card style={{ height: "100%", width: "100%", padding: "10%", margin: "1%", }}>
                        <div style={{ display: "grid", height: "100%", width: "100%", position: "relative", gridTemplateRows: "10% 70% 10% 10%" }}>
                            ...
                            <div style={{ display: "grid", justifyContent: "center", gridTemplateRows: "auto auto aut", rowGap: "0px", marginBottom: "0%", marginTop: "30%", marginBottom: "10%" }}>
                            ...
                            <div className="grid" style={{ gridTemplateColumns: "auto auto" }}>
                                <div className="task">
                                    <FaTasks size={20} color="#333" aria-label="tasks icon" />
                                    <p><span>Tasks:</span> {taskAllocated}</p>
                                </div>
                                <div className="Project">
                                    <GoProject size={20} color="#333" aria-label="tasks icon" />
                                    <p><span>Project:</span> {ProjectAllocated}</p>
                                </div>
                            </div>
                        </div>
                    </Card>
                ...
                <div className="justify-left item-start" style={{ display: "grid", gridTemplateRows: "60% 40%", padding: "10px", margin: "1%" }}>
                    ...
                    <div style={{ backgroundColor: "blue", width: "100%", marginTop: "1%" }}>
                        <Card style={{ height: "100%", width: "100%" }}>
                            <div className="justify-left item-start">
                                <p>test2</p>
                            </div>

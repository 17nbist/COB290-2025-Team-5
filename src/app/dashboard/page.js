      ...
      <div style={{ display: "grid", gridTemplateColumns: "30% 70%", height: "100%", width: "100%", backgroundColor: "blue" }}>
        ...
        <div style={{ padding: "10px" }}>
          ...
          <Card style={{ height: "100%", width: "100%", padding: "10%", margin: "1%" }}>
            <div style={{ display: "grid", height: "100%", width: "100%", position: "relative", gridTemplateRows: "10% 80% 10%" }}>
              ...
              <div style={{ display: "grid", justifyContent: "center", gridTemplateRows: "70% 30%" }}>
                <div style={{ justifySelf: "center" }}>
                  <Image src="/defaultPFP.png" alt="Profile Picture" width={60} height={60} />
                </div>

                <p className="center" style={{ marginTop: "10%" }}>User number 0</p>
              </div>
            </div>
          </Card>
        </div>

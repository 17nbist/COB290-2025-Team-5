export const forumPosts = [
    ...
    {
        id: 4,
        title: "Updated Vacation Policy for 2026",
        flair: "non-technical",
        preview:
            "Hi team, HR has reviewed and updated the vacation request policy, effective January 1st. Please review the key changes...",
        content:
            "Hi team,\n\nHR has reviewed and updated the vacation request policy, effective January 1st.\n\nKey Changes:\n1. All vacation requests must be submitted at least 2 weeks in advance.\n2. Requests during peak holiday season (Dec 20 - Jan 2) must be submitted by November 1st.\n3. Rollover days are now capped at 5 days, down from 10.\n\nPlease find the full policy document on the intranet under HR > Policies.\n\n- Karen",
        timeAgo: "1 day ago",
        tags: ["hr", "policy", "vacation", "pto"],
        upvotes: 22,
        downvotes: 3,
        comments: [
            {
    ...
    {
        id: 13,
        title: "Parking Lot Update - Repaving Section B",
        flair: "non-technical",
        preview:
            "FYI: Section B of the parking lot (north side) will be closed for repaving from next Monday to Wednesday. Please plan...",
        content:
            "FYI: Section B of the parking lot (north side) will be closed for repaving from next Monday to Wednesday.\n\nPlease plan to park in Section A or C. Expect the lot to be fuller than usual.\n\nWe recommend carpooling or using public transport if possible on those days. Apologies for the inconvenience.",
        timeAgo: "4 days ago",
    ...
    },
    {
        ...
        flair: "non-technical",
        preview:
            "This is your weekly reminder that the 4th-floor refrigerator will be cleaned out this Friday at 4:00 PM. Please remove...",
        content:
            "This is your weekly reminder that the 4th-floor refrigerator will be cleaned out this **Friday at 4:00 PM.**\n\nPlease remove any personal items you wish to keep by this time.\n\nAll remaining items, including containers, will be disposed of. Let's work together to keep our kitchen clean!",
        timeAgo: "1 day ago",
        ...
        comments: [
            {
                id: 222,
                author: "employee2@gmail.com",
                text: "Not again... someone always throws out my yogurt before Friday.",
                timeAgo: "1 day ago",
            },
        ],
        author: "hr1@gmail.com",
    ...
    {
        id: 18,
        title: "Frontend Best Practices: State Management",
        flair: "technical",
        preview:
            "Hey dev team, I'm starting a new feature and I'm wondering what our current best practice is for state management. Are we using...",
        content:
            "Hey dev team,\n\nI'm starting a new feature and I'm wondering what our current best practice is for state management.\n\nAre we using context, Redux, Zustand, or just component state? The 'Project Apex' codebase seems to use a mix of context and Redux.\n\nLooking for guidance on what to use for new development.",
        timeAgo: "5 days ago",
        tags: ["frontend", "react", "state-management", "best-practices"],
        upvotes: 11,
        downvotes: 0,
        comments: [
            {
    ...
    },
    {
        ...
        content:
            "Hi everyone,\n\nThis is an advance notice that we will be conducting a mandatory, building-wide fire drill next **Tuesday, October 28th.**\n\nThe alarm will sound at approximately **10:30 AM**.\n\nPlease familiarize yourself with the evacuation routes posted near your desk and in the hallways. The muster point is in the main parking lot (Section C).\n\nYour safety is our priority. Thank you for your cooperation.",
        timeAgo: "5 days ago",
    ...
    {
        id: 23,
        title: "How to request a new software license?",
        flair: "technical",
        preview:
            "My team needs a license for 'Sketch' for a new design project. What's the correct procedure for this? Do I just file an...",
        content:
            "My team needs a license for 'Sketch' for a new design project. What's the correct procedure for this?\n\nDo I just file an IT ticket, or does it need manager approval first?",
        timeAgo: "10 days ago",
        tags: ["help", "software", "license", "it"],
        upvotes: 4,
        downvotes: 0,
        comments: [
            {
    ...
    },
    {
        ...
        flair: "non-technical",
        preview:
            "Hi all, open enrollment is next month. We've just received the updated 2026 benefits guide from our provider. Please review...",
        content:
            "Hi all,\n\nOpen enrollment is next month. We've just received the updated 2026 benefits guide from our provider.\n\nPlease review the changes, as there are slight modifications to the PPO plan deductibles and co-pays.\n\nThe full guide is now available on the intranet: HR > Benefits > 2026 Health Guide.\n\nWe will also host a Q&A session with our provider rep next Wednesday.",
        timeAgo: "3 days ago",
        tags: ["hr", "benefits", "health", "insurance", "open-enrollment"],
        upvotes: 13,
        downvotes: 0,
        comments: [],
        author: "hr1@gmail.com",
    ...
    },
    {
        ...
        content:
            "Is anyone else on the 4th floor (dev area) finding it extremely hot? The thermostat seems to be locked but it feels like it's 80 degrees in here.\n\nIt's making it really hard to concentrate. Can facilities please check this?",
        timeAgo: "1 day ago",
    ...
    },
    {
        ...
        flair: "non-technical",
        preview:
            "Hi all! I'm organizing a charity bake sale to support the City Food Bank. It will be next Thursday in the 3rd floor breakroom...",
        content:
            "Hi all!\n\nI'm organizing a charity bake sale to support the City Food Bank. It will be next Thursday (Nov 6th) in the 3rd floor breakroom from 10 AM - 2 PM.\n\nAll proceeds will be matched by Make-It-All!\n\nPlease message me if you'd like to contribute by baking something. And don't forget to bring cash!",
        timeAgo: "2 days ago",
    ...
    {
        id: 51,
        title: "Looking for a carpool from Northside",
        flair: "non-technical",
        preview:
            "My car is in the shop for the next two weeks. Is anyone driving in from the Northside area who would be willing to carpool?...",
        content:
            "My car is in the shop for the next two weeks. Is anyone driving in from the Northside area who would be willing to carpool?\n\nI'm happy to pitch in for gas! My hours are generally 9 AM to 5 PM.",
        timeAgo: "1 day ago",
        tags: ["social", "carpool", "help"],
        upvotes: 4,
        downvotes: 0,
        comments: [],
        author: "employee2@gmail.com",
